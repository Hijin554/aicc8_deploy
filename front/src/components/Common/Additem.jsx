...
import { IoMdAddCircleOutline } from "react-icons/io5";
...
const Additem = () => {
  ...
  return (
    <div className='add-card item w-3/1 h-[25vh] p-[0.25rem]'>
        <div className='w-full h-full border-gray-500 rounded-md flex py-3 items-center justify-center'>
